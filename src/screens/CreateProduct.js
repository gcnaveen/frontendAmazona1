...
countInStock:'',productDiscountedPrice:'',categoryID:''})
...
setProductImages({...productImages,image:e.target.files[0]})
 ...
 axios.post('/api/products/createProduct', formData,{}).then(res => {
  ...
  return <div className='container'>
    ...
    <div className='row'>
      <div className='col-md-6 col-sm-12'>
        <label>Category</label>
          <select className='form-select'  name='category' onChange={handleInputFields}>
       ...
       <div className='col-md-6 col-sm-12'>
        <label>Sub Category</label>
          <select className='form-select' name='subCategory' defaultValue={''} onChange={handleInputFields}>
    ...
    <div className='row'>
      <div className='col-md-4 col-sm-12'>
        <label>Price</label>
        <input onChange={handleInputFields} name='price' className='form-control' />
      </div>
       <div className='col-md-4 col-sm-12'>
        <label>Discount Price</label>
        <input onChange={handleInputFields} name='productDiscountedPrice' className='form-control' />
      </div>
      <div className='col-md-4 col-sm-12'>
        <label>Count in Stock</label>
        <input onChange={handleInputFields} name='countInStock' className='form-control' />
      </div>
    </div>
    <div className='row'>
      <div className='col-md-6 col-sm-12'>
        <label>Brand</label>
        <input onChange={handleInputFields} name='brand' className='form-control' />
      </div> 
      <div className='col-md-6 col-sm-12'>
        <label>Description</label>
        <textarea name='description' onChange={handleInputFields}   className='form-control' />
      </div>
    </div>
